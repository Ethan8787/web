...
const skillsData =
    [{
        name: 'GEPT 初級',
        level: 100,
        details: 'Test-Time: 2024-09-21 / 聽-108, 讀-100, 寫-95, 說-90.',
        img: '/gept.png'
    },
    {
        name: 'Java',
        level: 19,
        details: 'Minecraft Plugins.'
    },
    {
        name: 'Python',
        level: 14,
        details: 'Discord Bots & Scripting'
    },
    {
        name: 'React',
        level: 16,
        details: 'Personal Portfolio Project'
    },
    {
        name: 'C++',
        level: 12,
        details: 'Qt Music Player (MP3/M3U)'
    },
    {
        name: 'C',
        level: 10,
        details: 'Brute-force & Image Processing'
    },
    {
        name: 'Markdown',
        level: 9,
    ...
    },
    {
        name: 'CSS',
        level: 11,
        details: 'Web Styling & Animations'
    }];
...
function SkillItem({name, level, details, img}) {
    ...
    return (<div className="skill-item-container">
        <div className="skill-main-row">
            <span className="skill-name" onClick={() => setIsOpen(!isOpen)}>{name}</span>
