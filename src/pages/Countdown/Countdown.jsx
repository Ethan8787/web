            ...
            <div className="carousel-viewport">
                <div className="carousel-track" style={{transform: `translateX(-${activeCard * 100}%)`}}>
                    <div className="carousel-slide">
                        <div className="countdown-card glass-card" ref={refs.grad}>
                            ...
                            <div className="grad-days-display">
                                ...
                                <span className="grad-days-total"> 天</span>
                            </div>
                    ...
                    <div className="carousel-slide">
                        <div className="countdown-card glass-card" ref={refs.exam}>
                            <h2 className="countdown-title">116 會考倒數</h2>
                            <div className="card-divider"></div>
                            <ExamCard/>
                            <div className="days-display">
                                <span className="days-left">{days.exam}</span>
                                <span className="days-total"> 天</span>
                            </div>
                            <p className="time-date">2027/5/22 08:20</p>
                            <div className="card-divider"></div>
